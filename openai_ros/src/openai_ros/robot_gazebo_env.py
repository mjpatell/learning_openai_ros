...
class RobotGazeboEnv(gym.Env):
    ...
    def __init__(self, robot_name_space, controllers_list, reset_controls, start_init_physics_parameters=True, reset_world_or_sim="SIMULATION"):
        ...
        #rospy.loginfo("states: " + str(self.state[0]) + str(self.state[1]) + str(self.state[2]) + str(self.state[3]))
    ...
    def render(self, mode='human'):
        rospy.loginfo("============ Calling env render function ==========")
        screen_width = 600
        screen_height = 400
        ...
        # problem is that still waiting for get state
        while self.state is None:
            self.state = self._get_obs()
            rospy.logwarn("Waiting for joint state ...")
